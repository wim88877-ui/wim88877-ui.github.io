<div style="text-align: center; padding-top: 10px;">
  <img src="wzy.jpg" alt="Zhiyan WANG" width="150" style="border-radius: 8px; border: 3px solid #fff; box-shadow: 0 4px 8px rgba(0,0,0,0.15);">
</div>
# Zhiyan WANG
...
## 📊 Selected Projects
### Bone Conduction Headphones Market Research
*National 2nd Prize - "Zheng Da Cup" Market Survey Competition*
* Led a 5-person team using **Python** to build regression models and identify key purchasing factors.
...
## 🛠️ Skills & Awards
* **Skills:** Python (Pandas/NumPy), SQL, Tableau, SPSS, MS Office.
* **Languages:** Cantonese (Native), Mandarin (Native), English (Proficient).
* **Awards:** 3rd Prize, National College Student Data Statistics Competition (2024); 2nd Prize, "Zheng Da Cup" (2023); CDA LEVEL I.
